...
class ProductOptionInline(admin.TabularInline):
    ...
    fields = ['option_detail', 'base_price', 'base_cost', 'is_active']
...
class ProductOptionAdmin(admin.ModelAdmin):
    list_display = ['product', 'option_detail', 'base_price', 'base_cost', 'is_active', 'created_at']
    ...
    fieldsets = (
        ('기본 정보', {
            'fields': ('product', 'option_detail', 'base_price', 'base_cost', 'is_active')
        }),
    )